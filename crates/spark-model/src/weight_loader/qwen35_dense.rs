        ...
        for (i, lt) in layer_types.iter().enumerate() {
            ...
            match lt {
                ...
                LayerType::LinearAttention => {
                    ...
                    // Atlas issue #A1 (port): free the BF16 qkvz_dense /
                    // out_proj_dense inputs now that the NVFP4 (and, when
                    // gated, FP8-prefill) copies are built. They are not kept
                    // as a third full-precision copy of the largest SSM tensor.
