# Harness aggregate — tier `pathrec` (N=10)

Generated from `bench/fp8_dgx2_drift/harness/runs/run_pathrec_*.json`.
Runs: [1, 10, 2, 3, 4, 5, 6, 7, 8, 9]

| metric | kind | n | mean ± std | p50 | p90 | 95% CI | non-zero runs |
|---|---|---|---|---|---|---|---|
| files_written | count | 10 | 1.700 ± 0.900 | 1.000 | 3.000 | [1.200, 2.300] | 10/10 |
...
| tool_calls_total | count | 10 | 7.900 ± 3.506 | 8.000 | 14.000 | [5.700, 10.100] | 10/10 |
| write_calls | count | 10 | 2.500 ± 1.432 | 2.000 | 5.000 | [1.700, 3.400] | 10/10 |
...
| atlas_ws1_mask_fires | count | 10 | 3.500 ± 1.360 | 4.000 | 6.000 | [2.700, 4.300] | 10/10 |
| atlas_b1_drift_fires | count | 10 | 0.500 ± 0.500 | 1.000 | 1.000 | [0.200, 0.800] | 5/10 |
...
| atlas_tool_call_lines | count | 10 | 7.900 ± 3.506 | 8.000 | 14.000 | [5.700, 10.100] | 10/10 |
| wall_time_s | count | 10 | 214.121 ± 85.343 | 207.848 | 360.071 | [163.587, 269.695] | 10/10 |
